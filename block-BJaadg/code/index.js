...
*/
let indexOfIs = queto.indexOf("is");
...
let quote = "There  is only one thing we say to death: Not today";
let indexOfIs = "is";
console.log(quote.indexOf("is"), indexOfIs.slice(0));
/*
...
console.log(quote.replace("today", "tomorrow"), to.concat(from));
/*
